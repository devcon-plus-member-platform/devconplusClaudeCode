...
// see the plain text in the registrant export rather than a sentinel.
        ...
        if (accessToken) {
          ...
          void supabase.functions.invoke('send-email', {
            body: {
              ...
              html: buildRegistrationConfirmationEmail({ memberName: user.full_name, eventTitle: event.title, eventDate, eventLocation: event.location ?? undefined, pointsValue: event.points_value ?? 100, ticketUrl }),
            },
          ...
          <>
            ...
            {customSchema.map(field => (
              <div key={field.id}>
                ...
                <DynamicField
                  field={field}
                  value={formResponses[field.id] ?? (field.type === 'checkbox' ? [] : '')}
